...
exclude = "angular, php, sharepoint, react, vue, Rust, golang, go, java, vba, node.js, повар, сушист, хостес, бар, бармен, официант, бариста, курьер, электрик, электромонтёр, слесарь, кассир, грузчик, игр, игра, игры, games, gambling, gamble"
region = "global"
