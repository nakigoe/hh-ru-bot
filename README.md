# Автоматизация отправки резюме и сопроводительных писем на hh.ru Vesrion 1.1 beta
...
<b>Важное обновление от 28 августа 2023:</b> добавлены `user agent`, `cookies` и `local storage` для быстрого логина без пароля, чтобы минимизировать детект автоматизации.

Добавлена пауза 10 секунд на экране первого логина на случай ввода капчи от руки.

Исправлен глюк заполнения простых анкет, теперь простые анкеты заполняются быстро и правильно содержимым файла со сносками на Ваши работы.
