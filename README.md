# Автоматизация отправки резюме и сопроводительных писем на hh.ru Vesrion 1.3
...
Скрипт написан и многократно протестирован для использования вместе с браузером ***Microsoft Edge***. Иногда установка **САМОЙ СВЕЖЕЙ ВЕРСИИ** ***Microsoft Edge*** на Ваше устройство обязательно для корректной работы автоматизации.
